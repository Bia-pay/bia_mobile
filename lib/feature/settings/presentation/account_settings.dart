...
class _UProfileState extends ConsumerState<UProfile> {
  ...
  final List<Map<String, dynamic>> othersItems = [
    {'title': 'Help', 'image': 'assets/svg/help.svg', 'hasDropdown': true},
    {
      ...
      'image': 'assets/svg/qr-code-1.svg',
      'hasDropdown': false,
    },
    {
      'title': 'Log Out',
  ...
  Future<void> _loadUserProfile() async {
    ...
    if (savedUserJson != null) {
      final cachedUser = UserResponse.fromJson(
        Map<String, dynamic>.from(savedUserJson),
      );
      setState(() {
        _user = cachedUser;
  ...
  void _showPinSetupModal(BuildContext context, Box box) {
    ...
    showModalBottomSheet(
      ...
      builder: (_) => _buildBottomSheetContainer(
        ...
        message:
            "Enter your 4-digit transaction PIN to link it to your fingerprint.",
  ...
  Widget _buildProfileHeader(BuildContext context) {
    ...
    final avatarUrl =
        'https://www.bigfootdigital.co.uk/wp-content/uploads/2020/07/image-optimisation-scaled.jpg'; // Optional: from user if available

    return Column(
      children: [
        CircleAvatar(radius: 50.r, backgroundImage: NetworkImage(avatarUrl)),
                ...
                return Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (subTitle == 'Pay with Fingerprint' ||
