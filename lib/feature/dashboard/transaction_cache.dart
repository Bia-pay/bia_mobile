  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final itemHeight = isSmallScreen ? 50.h : 60.h;
        final maxVisibleItems = (availableHeight / itemHeight).floor().clamp(2, 6);
        ...
        return Column(
          ...
          children: [
            ...
            /// 🔥 LIST with responsive item sizing
            Expanded(
